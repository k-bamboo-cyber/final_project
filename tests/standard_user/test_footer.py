...
class TestFooter:
    ...
    def test_twitter_link(self, app, standard_login, clear_cart):
        """
        1. Авторизоваться
    ...
    def test_facebook_link(self, app, standard_login, clear_cart):
        """
        1. Авторизоваться
    ...
    def test_linkedin_link(self, app, standard_login, clear_cart):
        """
        1. Авторизоваться
