...
class TestSorting:
    ...
    def test_az_sorting(self, app, glitch_login):
        """
        1. Авторизоваться
    ...
    @pytest.mark.xfail(reason="glitch user")
    def test_za_sorting(self, app, glitch_login):
        """
        1. Авторизоваться
    ...
    @pytest.mark.xfail(reason="glitch user")
    def test_lh_sorting(self, app, glitch_login):
        """
        1. Авторизоваться
    ...
    @pytest.mark.xfail(reason="glitch user")
    def test_hl_sorting(self, app, glitch_login):
        """
        1. Авторизоваться
    ...
    @pytest.mark.xfail(reason="glitch user")
    def test_switch_sort(self, app, glitch_login):
        """
        1. Авторизоваться
